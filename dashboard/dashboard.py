...
with st.sidebar:
    ...
    with col1:
        st.write(' ')
    with col2:
        # Gunakan URL untuk gambar logo jika dihosting di GitHub
        st.image("https://raw.githubusercontent.com/dhiyayasyifa/data-analyst/main/dashboard/logo.png", width=200)
    with col3:
        st.write(' ')
