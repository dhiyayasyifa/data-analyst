...
all_df = pd.read_csv('D:\KULIAH\MBKM\COURSERA\data-analyst\dashboard\df.csv')
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('D:\KULIAH\MBKM\COURSERA\data-analyst\dashboard\geolocation.csv')
