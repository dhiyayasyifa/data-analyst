...
# Fungsi untuk memuat data dari URL raw
...
# Dataset URLs
df_url = 'https://raw.githubusercontent.com/dhiyayasyifa/data-analyst/refs/heads/main/dashboard/df.csv'
geolocation_url = 'https://raw.githubusercontent.com/dhiyayasyifa/data-analyst/refs/heads/main/dashboard/geolocation.csv'

# Memuat dataset
all_df = load_data_from_url(df_url)
geolocation = load_data_from_url(geolocation_url)

# Kolom waktu
datetime_cols = ["order_approved_at", "order_delivered_carrier_date", "order_delivered_customer_date", "order_estimated_delivery_date", "order_purchase_timestamp", "shipping_limit_date"]

if all_df is not None:
    # Proses DataFrame utama
...
st.caption('Copyright (C) Dhiya Yasyifa Hani 2024')
